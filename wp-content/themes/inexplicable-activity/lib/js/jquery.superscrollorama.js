...
(function($) {
	...
	$.superscrollorama = function(options) {
		...
		var animObjects = [],
			pinnedObjects = [],
			scrollContainerOffset = {x: 500, y: 500},
		...
		function checkScrollAnim() {
			...
			var offsetAdjust = superscrollorama.settings.triggerAtCenter ? (superscrollorama.settings.isVertical ? - $window.height()/2-250 : - $window.width()/2) : 0;
